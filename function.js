...
function isScrapperBot(normalizedUserAgent) {
    return /presto|trident|crios|fxios|yaapp_android|yasearchbrowser|ev-crawler|seamus the search engine|dataforseobot|webscraperbot|pimeyes-downloader-api|sleepbot|\bptst\//.test(normalizedUserAgent);
}
